                ...
                <div class="widget-body">
                    <div class="widget-main">
                        <form class="form-inline" method="get">
                            <input type="text" name="title" value="<?php echo Yii::app()->request->getParam('name', '') ?>" class="input-medium" placeholder="名称">
                            <button type="submit" class="btn btn-purple btn-sm">
                                搜索
                                <i class="icon-search icon-on-right bigger-110"></i>
                            </button>
                            <a href="<?php echo $this->createUrl('create',array('type'=>Yii::app()->request->getParam('type',0))) ?>" class="btn btn-primary btn-sm">添加</a>
